      ...
      <div style={{ maxWidth: 520, width: "100%" }}>
        ...
        {today && (
          <div className="card mb-24"
               style={{ background: "var(--accent-dim)", borderColor: "var(--border-accent)", padding: "12px 16px" }}>
            ...
            {today.reflection &&
              <p style={{ color: "var(--text-muted)", fontSize: "0.78rem", marginTop: 6 }}>{today.reflection}</p>}
          </div>
        )}
